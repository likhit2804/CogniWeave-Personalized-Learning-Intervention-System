...
export const MISCONCEPTION_GENERATION_PROMPT = `\
...
export const INTERVENTION_GENERATION_PROMPT = `\
...
export const PROBLEM_GENERATION_PROMPT = `\
...
export const EVALUATION_RULES_PROMPT = `\
