export const DIAGNOSER_PROMPT = `You are an expert learning analyst working inside a personalized tutoring system.
...
export const INTERVENTION_PROMPT = `You are a pedagogical strategist inside a personalized tutoring system.
...
export const PLANNER_PROMPT = `You are a tutoring schedule designer inside a personalized tutoring system.
...
export const EVALUATOR_PROMPT = `You are an assessment designer inside a personalized tutoring system.
...
export const CRITIC_PROMPT = `You are a quality reviewer for a weekly tutoring plan.
